  ...
  return (
    <View>
      ...
      <View borderRadius={6} style={styles.content}>
        <Image style={{ width: coverWidth, height: coverHieght }} assetName="fangchong1" assetGroup="images" />
        <View backgroundColor='#fff'>
          <View padding-16 row>
            <View paddingR-16 flex><Text text70>春季防虫有高招 飞天防治已凯旋</Text></View>
            <Image aspectRatio={1} style={{ width: 100, height: 100 }} assetName="fangchong2" assetGroup="images" />
          </View>
          <View padding-16 row>
            <View paddingR-16 flex><Text text70>春季防虫有高招 飞天防治已凯旋</Text></View>
            <Image aspectRatio={1} style={{ width: 100, height: 100 }} assetName="fangchong2" assetGroup="images" />
